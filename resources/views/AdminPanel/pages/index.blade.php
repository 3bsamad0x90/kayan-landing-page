                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body pb-5 px-sm-5 pt-50">
                                    ...
                                    {{Form::open(['url'=>route('admin.pages.update',['id'=>$page->id]), 'id'=>'editpageForm', 'class'=>'row gy-1 pt-75'])}}
                                        ...
                                        <div class="col-12 col-md-4">
                                            <label class="form-label" for="title_fr">{{trans('common.title_fr')}}</label>
                                            {{Form::text('title_fr',$page->title_fr,['id'=>'title_fr', 'class'=>'form-control'])}}
                                        </div>
                                        ...
                                        <div class="col-12 col-md-12">
                                            <label class="form-label" for="content_fr">{{trans('common.content_fr')}}</label>
                                            {!!Form::textarea('content_fr',$page->content_fr,['id'=>'content_fr', 'class'=>'form-control editor_en'])!!}
                                        </div>  
            ...
            <div class="modal-content">
                ...
                <div class="modal-body pb-5 px-sm-5 pt-50">
                    ...
                    {{Form::open(['url'=>route('admin.pages.store'), 'id'=>'createpageForm', 'class'=>'row gy-1 pt-75'])}}
                        ...
                        <div class="col-12 col-md-4">
                            <label class="form-label" for="title_fr">{{trans('common.title_fr')}}</label>
                            {{Form::text('title_fr','',['id'=>'title_fr', 'class'=>'form-control'])}}
                        </div>
                        ...
                        <div class="col-12 col-md-12">
                            <label class="form-label" for="content_fr">{{trans('common.content_fr')}}</label>
                            {{Form::textarea('content_fr','',['id'=>'content_fr', 'class'=>'form-control editor_en'])}}
                        </div>
                        <div class="col-12 text-center mt-2 pt-50">
                            <button type="submit" class="btn btn-primary me-1">{{trans('common.Save changes')}}</button>
                            <button type="reset" class="btn btn-outline-secondary" data-bs-dismiss="modal" aria-label="Close">
