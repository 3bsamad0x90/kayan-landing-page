...
class User extends Authenticatable
{
    ...
    public function apiData($lang,$details = null)
    {
        $data = [
            ...
            // 'country' => $this->countryData != '' ? $this->countryData->apiData($lang) : ['id'=>'','name'=>'','country_code'=>''],
            'governorate' => $this->governorateData != '' ? $this->governorateData->apiData($lang) : ['id'=>'','name'=>'','name_en'=>''],
            'city' => $this->cityData()
